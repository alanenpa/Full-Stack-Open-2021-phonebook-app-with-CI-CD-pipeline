describe('Phonebook', function() {
  beforeEach(function() {
    cy.request('POST', 'http://localhost:4000/api/persons/reset')
  })
...
describe('Phonebook with entries', function() {
  beforeEach(function() {
    ...
    cy.request('POST', 'http://localhost:4000/api/persons', entry1)
    const entry2 = {
      name: 'Vonnegut',
      number: '0011224455'
    }
    cy.request('POST', 'http://localhost:4000/api/persons', entry2)
    const entry3 = {
      name: 'Huxley',
      number: '0101010101'
    }
    cy.request('POST', 'http://localhost:4000/api/persons', entry3)
    cy.visit('http://localhost:4000')
    cy.wait(1000) 
  })
